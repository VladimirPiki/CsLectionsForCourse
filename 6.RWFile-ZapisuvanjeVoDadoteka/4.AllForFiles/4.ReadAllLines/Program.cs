 ...
 */
            ...
            /*   var source = @"C:\temp\MyTest.txt";
               var destination = @"C:\temp\text.txt";
               try
               {
            ...
            /*  string[] fileEntries = Directory.GetFiles(@"C:\temp"); // ke ni treba za denes
              foreach (string fileName in fileEntries)
            ...
            //if (File.Exists(@"C:\temp\izbrisi\text.txt"))
            //{
            //    File.Delete(@"C:\temp\izbrisi\text.txt");
            //}
        }
    }
}
