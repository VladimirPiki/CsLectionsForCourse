...
namespace prezimeFibonaci
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Licnost lic;
            List<Licnost> listLic = new List<Licnost>();
            List<Licnost> reportList = new List<Licnost>();
           ...
           * listLic = DolzinaNaPrezimeKoePripagjaFibonaci(listLic);
            ...
            reportList = DolzinaNaPrezimeKoePripagjaFibonaci(listLic);

            for (int a=0;a < reportList.Count;a++)
            {
                Console.WriteLine(reportList[a].ime + "  " + reportList[a].prezime + "  " + reportList[a].godini);
            }
