...
using static Z70.SQLServerOcenkOneToMany.Database;
...
namespace Z70.SQLServerOcenkOneToMany
{
    public partial class Form1 : Form
    {
        ...
        private void tbAttachemt_TextChanged(object sender, EventArgs e)
        {
        ...
        private void cbUcebnaGodina_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void tbMaticenBr_TextChanged(object sender, EventArgs e)
        {
        ...
        private void btnPrezemiPodatoci_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string connectionString = "Server= localhost\\SQLExpress; Database= Z70SQLServerOcenkOneToMany; Integrated Security=True;";
