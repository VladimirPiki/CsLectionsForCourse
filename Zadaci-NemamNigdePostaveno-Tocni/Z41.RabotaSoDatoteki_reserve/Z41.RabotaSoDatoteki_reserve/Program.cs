    ...
    internal class Program
    {
        ...
        static void FindDuplicatAndDelete()
        {
            ...
            if (prodolziSoDuplikati == "Da" || prodolziSoDuplikati == "da" || prodolziSoDuplikati == "DA")
            {
                ...
                {
                    //Console.WriteLine();
                    //Console.WriteLine("Dokolku sakate da barate duplikati SAMO VO EDEM DIREKTORIUM VNESETE: 1");
                    //Console.WriteLine("Dokolku sakate da barate duplikati VO POVEKE DIREKTORIUM VNESETE:    2");
                    //int folderIliFolderi = int.Parse(Console.ReadLine());

                    //if (folderIliFolderi == 1)
                    //{
                    //    Console.WriteLine("Vnesete Folder ili cela pateka na folderi");
                    //    string folderDuplikat = Console.ReadLine();
                    //    string daliPostojFolderot = DaliFolderotPostoi(particijaDuplikat, folderDuplikat);
                    //    if (daliPostojFolderot == "-1")
                    //    {
                    //        Console.WriteLine("Folderot ne postoi !!!");//tolku kraj zavrshavsh
                    //    }
                    //    else
                    //    {
                    //        // var najdi = new SortedDictionary<int, string>();
                    ...
                    //                if (Int32.TryParse(broj, out int redenBrojZaBrisenje))
                    //                {
                    //                    string deleteFile = DeleteFile(redenBrojZaBrisenje, listaDuplikati, particijaDuplikat, folderDuplikat);
                    //                    Console.WriteLine(deleteFile);
                    //                }
                    //                else
                    //                {
